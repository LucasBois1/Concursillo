<template>
  <div class="lg:w-1/3 lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2">
    ...
    <div class="absolute top-0 left-0 ml-4 mt-5 lg:ml-20 animate__animated animate__fadeIn animate__slow animate__delay-2s">
      <button v-if="this.online && this.admin && this.alive" class="flex justify-center items-center p-2 drop-shadow-md antialiased font-bold">
        <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-400" height="1.5em" viewBox="0 0 512 512"><path d="M256 0c36.8 0 68.8 20.7 84.9 51.1C373.8 41 411 49 437 75s34 63.3 23.9 96.1C491.3 187.2 512 219.2 512 256s-20.7 68.8-51.1 84.9C471 373.8 463 411 437 437s-63.3 34-96.1 23.9C324.8 491.3 292.8 512 256 512s-68.8-20.7-84.9-51.1C138.2 471 101 463 75 437s-34-63.3-23.9-96.1C20.7 324.8 0 292.8 0 256s20.7-68.8 51.1-84.9C41 138.2 49 101 75 75s63.3-34 96.1-23.9C187.2 20.7 219.2 0 256 0zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"/></svg>
      </button>
      <button v-if="this.online && !this.admin && this.alive" class="flex justify-center items-center p-2 drop-shadow-md antialiased font-bold">
        <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512"><path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z"/></svg>
      </button>
      <button v-if="this.online && !this.alive" class="flex justify-center items-center p-2 drop-shadow-md antialiased font-bold">
        <svg xmlns="http://www.w3.org/2000/svg" class="fill-red-700" height="1.5em" viewBox="0 0 512 512"><path d="M416 398.9c58.5-41.1 96-104.1 96-174.9C512 100.3 397.4 0 256 0S0 100.3 0 224c0 70.7 37.5 133.8 96 174.9c0 .4 0 .7 0 1.1v64c0 26.5 21.5 48 48 48h48V464c0-8.8 7.2-16 16-16s16 7.2 16 16v48h64V464c0-8.8 7.2-16 16-16s16 7.2 16 16v48h48c26.5 0 48-21.5 48-48V400c0-.4 0-.7 0-1.1zM96 256a64 64 0 1 1 128 0A64 64 0 1 1 96 256zm256-64a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>
      </button>
    ...
    <div class="w-full animate__animated animate__fadeIn animate__slow animate__delay-2s">
      <div class="row">
        <div class="grid relative left-1/2 transform -translate-x-1/2 grid-cols-2 gap-4 mb-4 p-4 rounded-2xl w-11/12" style="background-color: rgba(0, 0, 0, 0.25);">
          ...
          <div class="flex justify-center items-center select-none rounded-full border-black border-4 bg-white drop-shadow-md col-span-2 text-xl antialiased font-bold min-h-[3rem]">
            <span id="subpregunta" class="absolute -bottom-50 -left-4 z-20 bg-yellow-200 border-yellow-600 px-2 rounded-full border-4 text-lg">2</span>
            PREGUNTA
          </div>
          
          <!-- RESPUESTAS -->
          <button id="respuestaA" v-on:click="this.selectAnswer('A')" class="select-none rounded-tl-full rounded-bl-full rounded-br-full border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[3rem]">
          ...
          <button id="respuestaB" v-on:click="this.selectAnswer('B')" class="select-none rounded-tl-full rounded-bl-full rounded-br-full border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[3rem]">
          ...
          <button id="respuestaC" v-on:click="this.selectAnswer('C')" class="select-none rounded-tl-full rounded-bl-full rounded-br-full border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[3rem]">
          ...
          <button id="respuestaD" v-on:click="this.selectAnswer('D')" class="select-none rounded-tl-full rounded-bl-full rounded-br-full border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[3rem]">
      ...
      <div class="row">
        <div class="grid relative left-1/2 transform -translate-x-1/2 grid-cols-4 gap-4 mb-4 p-4 rounded-2xl w-9/12" style="background-color: rgba(0, 0, 0, 0.25);">
          <button v-on:click="this.tab = 'inicio'" v-if="this.admin" class="flex justify-center items-center rounded-lg border-4 border-black p-1 bg-white drop-shadow-md antialiased font-bold">
            ...
            <button v-on:click="this.tab = 'inicio'" v-else class="flex col-span-2 justify-center items-center rounded-lg border-4 border-black p-1 bg-white drop-shadow-md antialiased font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 576 512"><path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c.2 35.5-28.5 64.3-64 64.3H128.1c-35.3 0-64-28.7-64-64V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
          </button>
          <button v-on:click="this.tab = 'comodines'" v-if="this.admin" class="flex justify-center items-center rounded-lg border-4 border-rose-500 p-1 bg-white drop-shadow-md antialiased font-bold">
          ...
          <button v-on:click="this.tab = 'comodines'" v-else class="flex col-span-2 justify-center items-center rounded-lg border-4 border-rose-500 p-1 bg-white drop-shadow-md antialiased font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512"><path d="M74.6 373.2c41.7 36.1 108 82.5 166.1 73.7c6.1-.9 12.1-2.5 18-4.5c-9.2-12.3-17.3-24.4-24.2-35.4c-21.9-35-28.8-75.2-25.9-113.6c-20.6 4.1-39.2 13-54.7 25.4c-6.5 5.2-16.3 1.3-14.8-7c6.4-33.5 33-60.9 68.2-66.3c2.6-.4 5.3-.7 7.9-.8l19.4-131.3c2-13.8 8-32.7 25-45.9C278.2 53.2 310.5 37 363.2 32.2c-.8-.7-1.6-1.4-2.4-2.1C340.6 14.5 288.4-11.5 175.7 5.6S20.5 63 5.7 83.9C0 91.9-.8 102 .6 111.8L24.8 276.1c5.5 37.3 21.5 72.6 49.8 97.2zm87.7-219.6c4.4-3.1 10.8-2 11.8 3.3c.1 .5 .2 1.1 .3 1.6c3.2 21.8-11.6 42-33.1 45.3s-41.5-11.8-44.7-33.5c-.1-.5-.1-1.1-.2-1.6c-.6-5.4 5.2-8.4 10.3-6.7c9 3 18.8 3.9 28.7 2.4s19.1-5.3 26.8-10.8zM261.6 390c29.4 46.9 79.5 110.9 137.6 119.7s124.5-37.5 166.1-73.7c28.3-24.5 44.3-59.8 49.8-97.2l24.2-164.3c1.4-9.8 .6-19.9-5.1-27.9c-14.8-20.9-57.3-61.2-170-78.3S299.4 77.2 279.2 92.8c-7.8 6-11.5 15.4-12.9 25.2L242.1 282.3c-5.5 37.3-.4 75.8 19.6 107.7zM404.5 235.3c-7.7-5.5-16.8-9.3-26.8-10.8s-19.8-.6-28.7 2.4c-5.1 1.7-10.9-1.3-10.3-6.7c.1-.5 .1-1.1 .2-1.6c3.2-21.8 23.2-36.8 44.7-33.5s36.3 23.5 33.1 45.3c-.1 .5-.2 1.1-.3 1.6c-1 5.3-7.4 6.4-11.8 3.3zm136.2 15.5c-1 5.3-7.4 6.4-11.8 3.3c-7.7-5.5-16.8-9.3-26.8-10.8s-19.8-.6-28.7 2.4c-5.1 1.7-10.9-1.3-10.3-6.7c.1-.5 .1-1.1 .2-1.6c3.2-21.8 23.2-36.8 44.7-33.5s36.3 23.5 33.1 45.3c-.1 .5-.2 1.1-.3 1.6zM530 350.2c-19.6 44.7-66.8 72.5-116.8 64.9s-87.1-48.2-93-96.7c-1-8.3 8.9-12.1 15.2-6.7c23.9 20.8 53.6 35.3 87 40.3s66.1 .1 94.9-12.8c7.6-3.4 16 3.2 12.6 10.9z"/></svg>
          </button>
          <button v-on:click="this.tab = 'media'" v-if="this.admin" class="flex justify-center items-center rounded-lg border-4 border-teal-500 p-1 bg-white drop-shadow-md antialiased font-bold">
          ...
          <button v-on:click="this.tab = 'reacciones'" v-if="this.admin" class="flex justify-center items-center rounded-lg border-4 border-indigo-500 p-1 bg-white drop-shadow-md antialiased font-bold">
          ...
          <!-- ACCIONES -->
          <button v-if="this.tab == 'inicio'" v-on:click="" class="flex col-span-2 justify-center items-center rounded-lg border-green-400 bg-green-100 border-4 p-2 drop-shadow-md antialiased font-bold">
          ...
          <button v-if="this.tab == 'inicio'" v-on:click="" class="flex col-span-2 justify-center items-center rounded-lg border-black bg-white border-4 p-2 drop-shadow-md antialiased font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"><path d="M0 80C0 53.5 21.5 32 48 32h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80zM64 96v64h64V96H64zM0 336c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V336zm64 16v64h64V352H64zM304 32h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H304c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48zm80 64H320v64h64V96zM256 304c0-8.8 7.2-16 16-16h64c8.8 0 16 7.2 16 16s7.2 16 16 16h32c8.8 0 16-7.2 16-16s7.2-16 16-16s16 7.2 16 16v96c0 8.8-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s-7.2-16-16-16s-16 7.2-16 16v64c0 8.8-7.2 16-16 16H272c-8.8 0-16-7.2-16-16V304zM368 480a16 16 0 1 1 0-32 16 16 0 1 1 0 32zm64 0a16 16 0 1 1 0-32 16 16 0 1 1 0 32z"/></svg>
          </button>
          <button v-if="this.tab == 'inicio'" v-on:click="" class="flex col-span-2 justify-center items-center rounded-lg border-black bg-white border-4 p-2 drop-shadow-md antialiased font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512"><path d="M69.3 4l48 32c11 7.4 14 22.3 6.7 33.3s-22.3 14-33.3 6.7l-48-32c-11-7.4-14-22.3-6.7-33.3S58.3-3.3 69.3 4zM597.3 44l-48 32c-11 7.4-25.9 4.4-33.3-6.7s-4.4-25.9 6.7-33.3l48-32c11-7.4 25.9-4.4 33.3 6.7s4.4 25.9-6.7 33.3zM24 160H88c13.3 0 24 10.7 24 24s-10.7 24-24 24H24c-13.3 0-24-10.7-24-24s10.7-24 24-24zm528 0h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552c-13.3 0-24-10.7-24-24s10.7-24 24-24zM117.3 332l-48 32c-11 7.4-25.9 4.4-33.3-6.7s-4.4-25.9 6.7-33.3l48-32c11-7.4 25.9-4.4 33.3 6.7s4.4 25.9-6.7 33.3zm432-39.9l48 32c11 7.4 14 22.3 6.7 33.3s-22.3 14-33.3 6.7l-48-32c-11-7.4-14-22.3-6.7-33.3s22.3-14 33.3-6.7zm-100.1 5.7c-19.8 27.1-39.7 54.4-49.2 86.2H240c-9.6-31.9-29.5-59.1-49.2-86.2l0 0 0 0c-5.2-7.1-10.4-14.2-15.4-21.4C155.6 247.9 144 213.3 144 176C144 78.8 222.8 0 320 0s176 78.8 176 176c0 37.3-11.6 71.9-31.4 100.3c-5 7.2-10.2 14.3-15.4 21.4l0 0 0 0zM400 432c0 44.2-35.8 80-80 80s-80-35.8-80-80V416H400v16zM320 96c8.8 0 16-7.2 16-16s-7.2-16-16-16c-61.9 0-112 50.1-112 112c0 8.8 7.2 16 16 16s16-7.2 16-16c0-44.2 35.8-80 80-80z"/></svg>
          </button>

          <!-- COMODINES -->
          <button v-if="this.tab == 'comodines'" class="flex col-span-4 justify-center items-center rounded-lg border-rose-500 border-4 p-2 bg-white drop-shadow-md antialiased font-bold">
          ...
          <!-- BOTONES -->
          <button v-if="this.tab == 'reacciones' && this.admin" v-on:click="this.confetti()" class="flex col-span-2 justify-center items-center rounded-lg border-4 border-indigo-500 p-2 bg-white drop-shadow-md antialiased font-bold">
          ...
          <button v-if="this.tab == 'reacciones' && this.admin" class="flex col-span-2 justify-center items-center disabled rounded-lg border-4 border-indigo-500 p-2 bg-white drop-shadow-md antialiased font-bold">
  ...
  <div class="absolute lg:w-1/3 lg:left-1/2 lg:transform lg:-translate-x-1/2 bottom-0 w-full animate__animated animate__fadeIn animate__slow animate__delay-2s">
    <div class="row">
      <div class="grid relative left-1/2 transform -translate-x-1/2 grid-cols-3 gap-4 mb-4 p-4 rounded-2xl w-11/12" style="background-color: rgba(0, 0, 0, 0.25);">
        ...
        <!-- <button v-on:click="this.shareUrl()" class="flex justify-center items-center rounded-lg border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold">
          <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"><path d="M352 224c53 0 96-43 96-96s-43-96-96-96s-96 43-96 96c0 4 .2 8 .7 11.9l-94.1 47C145.4 170.2 121.9 160 96 160c-53 0-96 43-96 96s43 96 96 96c25.9 0 49.4-10.2 66.6-26.9l94.1 47c-.5 3.9-.7 7.8-.7 11.9c0 53 43 96 96 96s96-43 96-96s-43-96-96-96c-25.9 0-49.4 10.2-66.6 26.9l-94.1-47c.5-3.9 .7-7.8 .7-11.9s-.2-8-.7-11.9l94.1-47C302.6 213.8 326.1 224 352 224z"/></svg>
        </button> -->
      </div>
    </div>
  </div>
    ...
    methods: {
      selectAnswer(respuestaSeleccionada) {
        this.ws.send(JSON.stringify({
          action: 'event',
          type: 'answer-change',
          answer: String(respuestaSeleccionada)
        }));
