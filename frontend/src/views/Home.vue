<template>
  ...
  <div class="absolute left-1/2 bottom-1/2 transform -translate-x-1/2 translate-y-1/2 w-11/12 lg:w-2/5 animate__animated animate__fadeIn animate__slow animate__delay-2s">
    <div class="row w-full">
      <div class="grid grid-cols-2 gap-4 mb-4 p-4 rounded-2xl" style="background-color: rgba(0, 0, 0, 0.25);">
        <!-- RESPUESTAS -->
        <a href="/controller" class="flex col-span-2 justify-center items-center rounded-lg border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[4rem]">
          <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512"><path d="M192 64C86 64 0 150 0 256S86 448 192 448H448c106 0 192-86 192-192s-86-192-192-192H192zM496 168a40 40 0 1 1 0 80 40 40 0 1 1 0-80zM392 304a40 40 0 1 1 80 0 40 40 0 1 1 -80 0zM168 200c0-13.3 10.7-24 24-24s24 10.7 24 24v32h32c13.3 0 24 10.7 24 24s-10.7 24-24 24H216v32c0 13.3-10.7 24-24 24s-24-10.7-24-24V280H136c-13.3 0-24-10.7-24-24s10.7-24 24-24h32V200z"/></svg>
        </a>
        ...
        <a href="/ui" class="flex justify-center items-center rounded-lg border-black border-4 p-2 bg-white drop-shadow-md antialiased font-bold min-h-[4rem]">
